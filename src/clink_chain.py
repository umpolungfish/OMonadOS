...
CLINK_CHAIN: List[ClinkLayer] = [
    ...
    ClinkLayer(3, "Molecule (Chemical Bonds)", "O_2",
        '𐑼', '𐑥', '𐑽', '𐑿', '𐑞', '𐑧', '𐑲', '𐑠',
        '⊙', '𐑓', '𐑳', '𐑭',
